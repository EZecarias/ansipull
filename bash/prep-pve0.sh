...
wget 192.168.0.101:8080/0/syncthing/syncthing@.service -P /etc/systemd/system/syncthing@.service
systemctl daemon-reload
systemctl enable syncthing@root.service

#copy syncthing configs from www
wget 192.168.0.101:8080/0/syncthing/config.xml -P ~/.config/syncthing/config.xml
wget 192.168.0.101:8080/0/syncthing/config.xml.v0 -P ~/.config/syncthing/config.xml.v0
